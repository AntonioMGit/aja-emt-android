...
class DatePickerFragment(val listener: (day:Int, month:Int, year:Int) -> Unit)
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val picker = DatePickerDialog(activity as Context, this, year, month, day) //Se le pasa el contexto, el listener, anio, mes y dia
        ...
        picker.datePicker.firstDayOfWeek = 2 //Para que empiece en lunes (1:Domingo, 2:Lunes, 3:Martes, 4:Miercoles, 5:Jueves, 6:Viernes, 7:Sabado)
    ...
    override fun onDateSet(p0: DatePicker?, year: Int, month: Int, dayOfMonth: Int) {
        listener(dayOfMonth, month, year); //Este listener ejecutara el codigo de la funcion showDatePickerDialog del MainActivity
    }
